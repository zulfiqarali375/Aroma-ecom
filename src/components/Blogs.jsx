    ...
    <div className="w-full py-4 flex items-center justify-center ">
      <div className="w-[92%] flex flex-col  md:flex-row justify-between items-start gap-4 md:gap-10 mt-16 ">
        ...
        >
          ...
          <button
            onClick={() => navigate("/Man")} // <-- works now
            className="mt-24 text-lg font-semibold hidden group-hover:block text-black relative group/button transition duration-300"
          >
            Shop Now
